...
ms.service: storage
---
# Azure Storage Common Client Library for C - version 12.13.0-beta.1 
++
...
[storage_contrib]: https://github.com/Azure/azure-sdk-for-cpp/blob/azure-storage-common_12.13.0-beta.1/CONTRIBUTING.md
